...
namespace 
{
	...
	std::string SetUp(GP& gp, std::string config_path, bool& save, std::string& save_as_path)
	{
		...
		int max_depth = ini.Read<int>(section, "max_depth");
		int max_length = ini.Read<int>(section, "max_length");
		...
		std::string trail_path = ini.Read<std::string>(section, "trail_path ");
